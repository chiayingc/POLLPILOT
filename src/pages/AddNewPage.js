...
function AddNewPage() {
    ...
    const saveSurveySettings = async () => {
        // console.log(surveyTitle, surveyWelcomeText, surveyThanksText, surveyKey, surveySerial, creater);
        // console.log(surveyStatus, surveyTitleAlign);
        // console.log(surveyShowNum);
            ...
            <div id='addnewpage_main'>
                <div id='survey_setting'>
                    ...
                    <div id='title_style'>
                        <h4>問卷標題設定</h4>
                        <div id='title_align'>
                            <button onClick={() => { surveyTitleAlign = 0; }}>
                            ...
                            <button onClick={() => { surveyTitleAlign = 1; }}>
                            ...
                            <button onClick={() => { surveyTitleAlign = 2; }}>
            ...
            <div id='title_style'>
                ...
                <div id='general_setting'>
                    ...
                    <div id='num_desplay'>
                        <h4>題號顯示</h4>
                        <div id='num_button'>
                            <button onClick={() => { surveyShowNum = true; }}>
                                顯示
                            </button>
                            <button onClick={() => { surveyShowNum = false; }}>
                                不顯示
                            </button>
                        </div>
                    </div>
