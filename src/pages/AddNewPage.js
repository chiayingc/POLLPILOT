...
function AddNewPage() {
    ...
    useEffect(() => {
      ...
      if (currentUser) {
        setUser(currentUser);
            ...
            const userData = doc(db, "allUsers", "user_" + currentUser.uid.substring(0, 4));
    ...
    const saveSurveySettings = async () => {
        ...
        const userSurveys = doc(db, "allUsers", "user_" + shortUid, "userSurveys", serial + "survey" + survey);
            ...
            .then(async () => {
                ...
                await setDoc(userData,
                    ...
                    .then(async () => {
                        ...
                        const countAns = doc(db, "allUsers", "user_" + shortUid, "userSurveys", serial + "survey" + survey, "Answers", "count");
                        await setDoc(countAns,
                            {
                                ansCount: 0
                            },
                            { merge: true })
