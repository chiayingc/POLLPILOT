...
function EditSettings({oldSettings}) {
    // console.log("12::::",oldSettings.name);
    // console.log("14::",oldSettings.surveySerial);
    ...
    if(oldSettings!={}){
        ...
        // surveyStatus=oldSettings.status;
        // document.querySelector("#status").value=oldSettings.status;
                ...
                <div id='general_setting'>
                    ...
                    <div id='survey_status'>
                        ...
                        <select id='status' onChange={(e) => {
                            ...
                            if(status==0){console.log(0); document.querySelector("#setKey").style.display="none"; surveyKey="";}
                            if(status==1){console.log(1); document.querySelector("#setKey").style.display="block"; }
                            if(status==2){console.log(2); document.querySelector("#setKey").style.display="none"; surveyKey="";}
